...
facebook_redirect_url= 'http://localhost:3000/save-credentials/'
...
facebook_page_access_token="""EAAUFRLCbo1MBANO0nNiHJZCRzBOhgr4NMZAFNlTtRxjej1l2wKgRvxGeP9BdFYs9ULZBQG6ArDLkgXqqR9Q5uwrwrWokj2mkWcfEg8XtbD277tEr53GjOCoOGIsstdPjsWaJka7VXooBoyL7tMWTrlv74qvi1qzNMwxYxZA1MoKFza8EqZCUIUuzG9PBFjegZD"""
...
linkedin_profile_id=''
# Facebook User ID
facebook_user_id='103995469037355'
# Facebook Page ID
...
def facebook_get_user_id():
    ...
    """
    global facebook_user_id,facebook_page_token_url
...
def facebook_get_page_id():
    ...
    """
    global facebook_page_id,facebook_request_url
    facebook_me_response=requests.get(facebook_me_url,  facebook_me_payload)
...
def linkedin_get_id():
    ...
    linkedin_register_body["registerUploadRequest"]['owner']=f"urn:li:person:{linkedin_profile_id}"
...
def authenticate_social(linkedinCode,facebookCode):
    ...
    return [linkedin_access_token,facebook_page_access_token]
